...
Introduction
==============================================
Checksheet manager provides its user with option of creating syllabus, making appointment with advisors, managing department information, and mainly management of checksheets. Because of the nature of the problem of checksheet management, the system is divded into three user groups with different allocated tasks and responsibilites which will be discussed in more detail in the next section.
